# Hi there! 👋 I'm Aadi Gautam

**Computer Engineering Graduate | Systems, Embedded & Machine Learning Enthusiast**

I'm a passionate Computer Engineer specializing in low-level systems programming, embedded hardware architectures, and end-to-end machine learning pipelines. Whether it's building a 32-bit operating system from scratch or designing hardware on FPGAs, I love solving complex problems at the intersection of hardware and software.

📫 **Let's Connect:** [LinkedIn](https://www.linkedin.com/in/aadi-gautam-61b464249) | ✉️ [gautamaadi.14@gmail.com](mailto:gautamaadi.14@gmail.com)

---

### 🚀 About Me
- 🎓 **Education:** B.Eng. in Computer Engineering (Specialized Honours) from York University – Lassonde School of Engineering.
- 🏆 **Achievements:** Recipient of the 2025 *Jarrell Family Interdisciplinary Award* for Engineering Innovation.
- 💼 **Goals:** Actively seeking entry-level roles in **Software Engineering, Embedded/Firmware, Cybersecurity, or Cloud/Network Engineering**.
- 🇨🇦 **Status:** Canadian Citizen | Eligible for Federal Secret Security Clearance | Open to relocation across Canada.

---

### 💻 Tech Stack & Tools
**Languages:** 
`C` | `C++` | `Python` | `Java` | `x86 Assembly` | `SystemVerilog` | `JavaScript` | `TypeScript` | `SQL` | `Bash`

**Systems & Hardware:** 
`Linux/Unix` | `Kernel Development` | `Custom Bootloaders` | `Memory Management` | `ARM Cortex-M` | `FPGA (Intel MAX10)` | `RTOS` | `QEMU` | `Bochs`

**Machine Learning & Data Science:** 
`Pandas` | `NumPy` | `Scikit-Learn` | `PCA` | `KNN` | `SVM` | `Random Forest` | `TensorFlow` | `DVC` | `MLFlow` | `Google Gemini AI` | `Prompt Engineering`

**Software Engineering & Networking:** 
`OOP` | `Agile/Scrum` | `Git` | `TCP/IP` | `Wireshark` | `MERN Stack` | `ModelSim` | `Verilator`

**Web & Deployment:** 
`Flask` | `Docker` | `Gunicorn` | `React 19` | `React Router v7` | `Tailwind CSS v4` | `Vite` | `Node.js` | `npm`
...
* **Modernizing Cross-Border Banking Program** (York University / RBC)
